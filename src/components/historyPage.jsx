...
const timelineData = [
  { year: "1920", event: "Farm Founded", description: `En lo profundo de las colinas verdes que rodean el pintoresco pueblo de San José de las Rosas, se
  ...
  { year: "1950", event: "First Barn Built", description: "The iconic barn was built, a key part of the farm’s infrastructure." },
  { year: "1990", event: "Modernization", description: "The farm embraced new technologies to improve crop production." },
  { year: "2020", event: "Farm Tours", description: "We opened our farm for tours, sharing our history with the community." }
];
      ...
      <div className="history-page" >
        ...
        <section  className={`gallery-section ${isGalleryInView ? 'visible' : ''}`}>
          ...
          <div className="gallery">
            <div className="gallery-item"><img src={img10} alt="Farm Image 1" /></div>
            <div className="gallery-item"><img src={img11} alt="Farm Image 2" /></div>
            <div className="gallery-item"><img src={img12} alt="Farm Image 3" /></div>
            <div className="gallery-item"><img src={img13} alt="Farm Image 4" /></div>
          </div>
        </section>
